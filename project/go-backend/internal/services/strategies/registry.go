...
func InitDefaultStrategies() {
	...
	RegisterDefault(NewRSIStrategy())
	RegisterDefault(NewMACDStrategy())
	RegisterDefault(NewBollingerBandsStrategy())
	RegisterDefault(NewEMACrossoverStrategy())
	RegisterDefault(NewVWAPStrategy())
	RegisterDefault(NewOBVStrategy())
	RegisterDefault(NewMeanReversionStrategy())
}
