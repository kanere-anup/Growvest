...
func SeedStrategies(db *gorm.DB) error {
	strategies := []models.Strategy{
		...
		},
		{
			...
			Description: "Identifies overbought (RSI > 70) and oversold (RSI < 30) conditions using the Relative Strength Index with Wilder's smoothing.",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Detects MACD line crossing the signal line. Bullish when MACD crosses above signal, bearish when below.",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Identifies stocks trading near or beyond their Bollinger Bands (2 standard deviations from 20-day SMA).",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Detects golden cross (short EMA crosses above long SMA) and death cross signals. Classic trend-following indicator.",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Identifies stocks trading near their VWAP. VWAP acts as a dynamic support/resistance level favored by institutional traders.",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Detects OBV divergence from price. Rising OBV with falling price suggests accumulation (bullish); falling OBV with rising price suggests distribution (bearish).",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
		...
		},
		{
			...
			Description: "Identifies stocks that have deviated significantly from their moving average using z-score analysis.",
			Category:    "technical",
			IsSystem:    true,
			IsActive:    true,
			Parameters: models.JSONB{
