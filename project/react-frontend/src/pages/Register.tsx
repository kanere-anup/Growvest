      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12">
          ...
          <div className="space-y-4">
            {[
              { icon: <Zap className="w-5 h-5" />, text: 'Lightning-fast stock scanning', desc: 'Screen 100+ NSE stocks in seconds' },
              { icon: <BarChart3 className="w-5 h-5" />, text: 'Advanced analytics & backtesting', desc: 'Test strategies against historical data' },
              { icon: <Shield className="w-5 h-5" />, text: 'Enterprise-grade security', desc: 'Your data is encrypted and protected' },
            ].map((feature, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-theme-tertiary mt-0.5">{feature.desc}</p>
                </div>
              </div>
            ))}
          </div>
                      ...
                      {[1, 2, 3, 4].map((level) => (
                        <div
                          ...
                          className={cn(
                            ...
                            level <= strength.level ? strength.color : (theme === 'dark' ? 'bg-surface-700' : 'bg-surface-200')
                          )}
                        />
                      ))}
                    </div>
                    <p className="text-xs text-theme-tertiary">{strength.label} password</p>
                  </div>
                )}
                {!password && (
