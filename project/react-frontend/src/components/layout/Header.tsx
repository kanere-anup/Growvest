...
const toolsNavItems = [
  { path: '/chart', label: 'Charts', icon: CandlestickChart },
  { path: '/backtest', label: 'Backtest', icon: FlaskConical },
  { path: '/composer', label: 'Composer', icon: Puzzle },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative" data-tools-menu>
              ...
              {toolsOpen && (
                <div className={cn(
                  "absolute left-0 mt-2 w-52 py-2 rounded-xl shadow-xl animate-slide-down border z-50",
                  theme === 'dark'
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ...
                            : theme === 'dark'
                              ? 'text-theme-secondary hover:bg-surface-700/50 hover:text-theme-primary'
                              : 'text-theme-secondary hover:bg-surface-50 hover:text-theme-primary'
                        )}
                      >
                        <Icon className="w-4 h-4" />
                        {item.label}
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative" data-user-menu>
              ...
              {userMenuOpen && (
                <div className={cn(
                  "absolute right-0 mt-2 w-48 py-2 rounded-xl shadow-xl animate-slide-down border z-50",
                  theme === 'dark'
                    ? "bg-surface-800 border-surface-700"
                    : "bg-white border-surface-200"
                )}>
        ...
        {mobileMenuOpen && (
          <nav className="lg:hidden py-4 border-t animate-slide-down">
            <div className="mb-2">
              <p className="px-4 py-1 text-xs font-medium text-theme-tertiary uppercase tracking-wider">
                Navigation
              </p>
            </div>
            {primaryNavItems.map((item) => {
