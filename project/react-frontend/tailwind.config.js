...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Sleek dark theme - inspired by trading terminals & fintech apps
        primary: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px -10px rgba(16, 185, 129, 0.5)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px -5px rgba(16, 185, 129, 0.4)' },
          '50%': { boxShadow: '0 0 30px -5px rgba(16, 185, 129, 0.6)' },
        },
        shimmer: {
